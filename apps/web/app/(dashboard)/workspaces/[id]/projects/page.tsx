...
export default function ProjectsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <section className="grid gap-6">
      ...
      <Card>
        {(workspace.isLoading || projects.isLoading) && <SkeletonRows rows={5} columns={3} />}
